...
pub(crate) fn analyze_chained_call<'a>(
        ...
        "call_expression" => {
            ...
            match function_node.kind() {
                        ...
                        .map_or(false, |n| n.kind() == "identifier") =>
                {
                    ...
                    {
                        trace!(
                            "  Outer call is Type Cast/Constructor '{}'. No outer step generated.",
                            name
                        );
                        ...
                        trace!("  Outer call is Simple Function Call '{}'", name);
                        let target =
                        ...
                        .map_or(false, |n| n.kind() == "member_expression") =>
                {
                    ...
                    trace!("  Outer call is Member Call '.{}'", property_name);
                    ...
                    if let Some(ref obj_type) = outer_object_type {
                        ...
                        trace!(
                            "    Failed to resolve object type for member call '.{}'",
                            property_name
                        );
    ...
    trace!("Analysis finished. Total steps generated: {}", steps.len());
    Ok(steps)
}
...
fn resolve_expression_type_v2<'a>(
    ...
    match expr_node.kind() {
        ...
        "call_expression" => {
            ...
            trace!("[Resolve Type V2]   Call expression: Analyzing call to determine return type.");
...
mod tests {
    ...
    fn test_analyze_simple_call() -> Result<()> {
        ...
        let call_expr_node =
            find_nth_node_of_kind(&tree, "call_expression", 0).expect("missing call expression"); // Add expect
